...
# Slider
age = st.sidebar.slider("Select you age", 0 , 100, 25)

# Selectbox
favorite_color = st.sidebar.selectbox("What is you favorite color?" , ["Blue", "Red", "Green", "Yellow"])
...
data = pd.DataFrame(
    ...
    columns=('col1 %d' % i for i in range(5))   
)
